...
<div class="container">
	...
	<ul class="nav nav-pills" role="tablist">
			...
			<li><a href="http://users.atw.hu/almasimilan/webaruhaz/videokartya.php">Videokartya</a></li>
			<li><a href="http://users.atw.hu/almasimilan/webaruhaz/memoria.php">Memoria</a></li>
			<li class="active"><a href="http://users.atw.hu/almasimilan/webaruhaz/processzor.php">Processzor</a></li>
...
<?php
// sql lekérdezések
$sql = "SELECT * FROM webaruhaz Where kategoria = \"proc\"";
